...
const HERO =
  "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=900&q=80";
...
export default function NGOPage() {
  ...
  const fetchDonations = async () => {
    try {
      const { data } = await getDonations({ status: "available", limit: 50 });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showMsg(err.response?.data?.message || "Failed to submit.", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const matched = requests.filter(
    (r) => r.status === "matched" || r.status === "fulfilled",
  ).length;
      ...
      <div style={{ position: "relative", height: 260, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg,rgba(27,67,50,.9),rgba(45,106,79,.7))",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            Resources for your
            <br />
            community, matched by AI.
          </h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,.75)" }}>
            Browse available donations → Submit request → Get matched
            automatically
          </p>
        </div>
      </div>
        ...
        >
          {[
            ...
            >
              ...
              <div style={{ fontSize: 11, color: "#9A8F80", marginTop: 2 }}>
                {s.label}
              </div>
            </div>
          ))}
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              <div>
                ...
                >
                  Browse donations below → Submit a request → Admin runs AI
                  match → Volunteer delivers to you
                </p>
              </div>
              <button
            ...
            {filtered.length === 0 ? (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#9A8F80", marginBottom: 16 }}>
                  Submit a request — we'll notify you when a match is found.
                </p>
                <button
                  onClick={() => setTab("submit")}
                  style={{
                ...
                {filtered.map((d) => (
                  ...
                  >
                    <div
                      style={{
                        height: 3,
                        background: "linear-gradient(90deg,#74C69D,#D4A853)",
                      }}
                    />
                    <div style={{ padding: "1.1rem 1.25rem" }}>
                      ...
                      >
                        ...
                        >
                          📍 {d.pickupAddress?.substring(0, 20) || "Available"}…
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {r.quantityNeeded} · {r.beneficiariesCount} people
                          </p>
                        </div>
                      </div>
                      <div
          ...
          >
                  ...
                  {CATS.map((c) => (
                    <div
                      ...
                      style={{
                        ...
                        background: form.category === c ? "#EAF5EE" : "#FEFAE0",
                        transition: "all .15s",
                      }}
                    >
                      ...
                      <div
                        style={{
                          fontSize: 11,
                          fontWeight: 600,
                          color: form.category === c ? "#1B4332" : "#9A8F80",
                        }}
                      >
                        {c.replace("_", " ")}
                      </div>
                ...
                {[
                  {
                    key: "title",
                    label: "Request Title",
                    ph: "e.g. Rice and Dal for 50 families",
                  },
                  {
                    key: "quantityNeeded",
                    label: "Quantity Needed",
                    ph: "e.g. 10kg, 50 portions, 3 bags",
                  },
                  {
                  ...
                  {
                    key: "deliveryAddress",
                    label: "Your NGO Address",
                    ph: "Full delivery address",
                  },
                ].map((f) => (
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: form.urgency === u ? s.bg : "#FEFAE0",
                          transition: "all .15s",
                        }}
                      >
                        <div
                          style={{
                            fontSize: 11,
                            fontWeight: 700,
                            color: form.urgency === u ? s.color : "#9A8F80",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              >
                ...
                >
                  Once you submit, our Claude AI analyzes your request against
                  all available donations — considering urgency, distance,
                  category, and beneficiary count to find the best match.
                </p>
              </div>
              <div
                style={{
          ...
          <div style={{ marginBottom: "2rem" }}>
            {deliveries.length === 0 ? (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#9A8F80" }}>
                  Submit a request and once matched, your delivery will appear
              ...
              deliveries.map((d) => (
                <div
                  ...
                  style={{
                    ...
                    marginBottom: 14,
                    border: "1px solid #F0EAD6",
                    boxShadow: "0 4px 16px rgba(27,67,50,.08)",
                  }}
                >
                  {/* Delivery header */}
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          {d.donation?.title || "Resource Delivery"}
                        </h4>
                        <p
                          style={{ fontSize: 12, color: "#9A8F80", margin: 0 }}
                        >
                          From:{" "}
                  ...
                  >
                    <div
                      style={{
                        ...
                        fontSize: 14,
                        fontWeight: 700,
                        color: d.volunteer ? "#D4A853" : "#9A8F80",
                      }}
                    >
                      {d.volunteer
                        ? d.volunteer.name.slice(0, 2).toUpperCase()
                        : "?"}
                    </div>
                    <div>
                      <div
                      ...
                      {d.volunteer?.trustScore && (
                        <div style={{ fontSize: 11, color: "#9A8F80" }}>
                          Trust Score:{" "}
                          <strong style={{ color: "#D4A853" }}>
                            {d.volunteer.trustScore}/10
                          </strong>
                        </div>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    >
                      {[
                        ...
                        const done =
                          order.indexOf(d.status) >= order.indexOf(s.key);
                        return (
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  fontSize: 16,
                                  marginBottom: 4,
                                  border: done ? "none" : "2px solid #E8DDB5",
                                  transition: "all .3s",
                                }}
                              >
                                {s.icon}
                            ...
                            {i < 3 && (
                              <div
                                style={{
                                  ...
                                  height: 2,
                                  background: done
                                    ? "linear-gradient(90deg,#74C69D,#D4A853)"
                                    : "#E8DDB5",
                                  marginBottom: 18,
                                  maxWidth: 40,
