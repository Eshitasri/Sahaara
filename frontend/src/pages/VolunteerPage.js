...
export default function VolunteerPage() {
  ...
  const fetchLeaderboard = async () => {
    try {
      const { data } = await getVolunteerLeaderboard();
      setLeaderboard(data.volunteers || []);
    } catch {}
  };
  ...
  const handleClaim = async (id) => {
    ...
    try {
      ...
      showMsg(err.response?.data?.message || "Could not claim.", "error");
    } finally {
      setClaiming(null);
    }
  };
  ...
  const handleToggle = async () => {
    try {
      await setAvailability(!isOnline);
      setIsOnline((v) => !v);
      showMsg(
      ...
      showMsg("Could not update status.", "error");
    }
  };
      ...
      <div style={{ position: "relative", height: 260, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg,rgba(27,67,50,.85),rgba(212,168,83,.4))",
          }}
        />
        <div
          style={{
          ...
          >
            <div
              ...
              style={{
                ...
                height: 28,
                borderRadius: 14,
                background: isOnline ? "#74C69D" : "rgba(255,255,255,.3)",
                position: "relative",
                cursor: "pointer",
            ...
            <span
              style={{
                fontSize: 14,
                fontWeight: 600,
                color: isOnline ? "#74C69D" : "rgba(255,255,255,.6)",
              }}
            >
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 1.5rem" }}>
          ...
          {[
            ...
            },
            {
              ...
              value: user?.totalDeliveries
                ? `${Math.round((user.successfulDeliveries / user.totalDeliveries) * 100)}%`
                : "—",
              color: "#2D6A4F",
            },
            {
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 11, color: "#9A8F80", marginTop: 5 }}>
              Complete more deliveries on time to increase your score
            </p>
          </div>
        </div>
            ...
            {available.length === 0 ? (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#9A8F80" }}>
                  New assignments appear here when donors upload and admin
                  matches them.
                </p>
              </div>
            ) : (
                ...
                {available.map((d) => (
                  ...
                  >
                    ...
                    <div
                      style={{
                        height: 4,
                        background: "linear-gradient(90deg,#1B4332,#D4A853)",
                      }}
                    />
                    <div style={{ padding: "1.25rem" }}>
                        ...
                        >
                          <span style={{ marginRight: 12 }}>
                            ...
                            <strong style={{ color: "#1B4332" }}>
                              {d.donation?.pickupAddress || "See details"}
                            </strong>
                          </span>
                        </div>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor:
                            claiming === d._id ? "not-allowed" : "pointer",
                          boxShadow: "0 3px 12px rgba(212,168,83,.3)",
                          transition: "all .2s",
                        }}
                      >
          ...
          <div style={{ marginBottom: "2rem" }}>
            {myDeliveries.length === 0 ? (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: "#9A8F80" }}>
                  Claim an available delivery to get started!
                </p>
              </div>
            ) : (
              myDeliveries.map((d) => {
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {[
                          ...
                          const done =
                            order.indexOf(d.status) >= order.indexOf(s);
                          return (
                            <React.Fragment key={s}>
                              <div
                                style={{
                                  ...
                                  padding: "2px 6px",
                                  borderRadius: 8,
                                  background: done ? "#D8F3DC" : "#F5F4F0",
                                  color: done ? "#1B4332" : "#B8B0A6",
                                  fontWeight: done ? 600 : 400,
                                }}
                              >
                                {
                                  ["Accepted", "Picked Up", "Transit", "Done"][
                                    i
                                  ]
                                }
                              </div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          justifyContent: "center",
                          padding: "1rem",
                          boxShadow: "0 8px 24px rgba(27,67,50,.2)",
                        }}
                      >
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: 12, color: "#9A8F80" }}>
                        {v.successfulDeliveries}/{v.totalDeliveries} deliveries
                        · {v.city || "N/A"}
                      </div>
                    </div>
                    {/* Mini bar */}
                    <div style={{ width: 80 }}>
                      ...
                      >
                        <span style={{ fontSize: 10, color: "#9A8F80" }}>
                          Trust
                        </span>
                        <span
                          style={{
