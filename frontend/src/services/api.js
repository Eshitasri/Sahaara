...
export const confirmPickup = (id, formData) =>
  API.patch(`/deliveries/${id}/pickup`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const confirmDelivery = (id, formData) =>
  API.patch(`/deliveries/${id}/deliver`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });

// ─── Match ────────────────────────────────────────────────────────────────────
export const matchDonation = (donationId) =>
  API.get(`/match/donation/${donationId}`);
...
export const setAvailability = (isAvailable) =>
  API.patch("/volunteers/availability", { isAvailable });
...
export const clearFraudFlag = (deliveryId) =>
  API.patch(`/fraud/clear/${deliveryId}`);
